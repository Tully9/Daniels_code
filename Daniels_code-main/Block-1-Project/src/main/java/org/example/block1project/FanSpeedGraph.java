...
public class FanSpeedGraph {
    ...
    private static final int UPDATE_INTERVAL = 100; // every 100 ms
    ...
    public FanSpeedGraph() {
        ...
        NumberAxis yAxis = new NumberAxis(0, 5000, 500); // adjust y-axis range as needed
    ...
    private void updateFanSpeed() {
        ...
        if (fanSpeed != -1) { // valid fan speed check
